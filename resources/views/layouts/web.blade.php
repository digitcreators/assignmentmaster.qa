...
<head>
    ...
    {{-- Favicon --}}
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('fav-icon.png') }}">
    
    {{-- Tailwind CSS --}}
        
    <link rel="stylesheet" href="{{ asset('dist/css/styling-6.css')}}">
    ...
    })(window,document,'script','dataLayer','GTM-5S54WR4T');</script>
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "Product", 
      "name": "@yield('title', '')",
      "image": "https://assignmentmaster.qa/public/imgs/hero-banner.webp",
      "description": "@yield('description')",
      "brand": {
        "@type": "Brand",
        "name": "Assignment Master Qatar"
      },
      "offers": {
        "@type": "Offer",
        "url": "@yield('canonical')",
    ...
    <!--Background image-->
    <link rel="preload" as="image" href="{{ asset('imgs/homepage-background.webp') }}" type="image/webp">
...
<body class="">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5S54WR4T"
...
s1.async = true;
s1.src = 'https://embed.tawk.to/68dcc885046fcb1955e2f839/default';
s1.charset = 'UTF-8';
