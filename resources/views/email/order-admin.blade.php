                      ...
                      <tbody>
                          <tr>
                              <td colspan="4" valign="top"
                                  style="border-collapse:collapse;border:0;margin:0;padding:0;color:#101820;font-family:Arial,sans-serif;font-size:16px;line-height:26px;background-color:#f0d1d1;border-bottom:4px solid #c35876;text-align:center">
                                  <a href="{{route('home')}}" target="_blank">
                                      <img  src="{{asset('imgs/logo.png')}}" alt="{{env('APP_NAME', config('app.name'))}}" style=" width:150px;">
                                  </a>
                              </td>
                          </tr>
                          <tr>
                          ...
                          <tr bgcolor="#fff" style="border-top:4px solid #c35876">
                              <td valign="top" style="border-collapse:collapse;border:0;margin:0;padding:0;color:#101820;font-family:Arial,sans-serif;font-size:16px;line-height:26px;background:#f0d1d1;text-align:center">
                                  <table style="font-weight:normal;border-collapse:collapse;border:0;margin:0;padding:0;font-family:Arial,sans-serif">
                                      <tbody>
                                          <tr>
