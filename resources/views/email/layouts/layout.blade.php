                            ...
                            <tbody>
                                <tr>
                                    <td colspan="4" valign="top"
                                        style="border-collapse:collapse;border:0;margin:0;padding:0;color:#555559;font-family:Arial,sans-serif;font-size:16px;line-height:26px;background-color:#f0d1d1;border-bottom:4px solid #c35876;text-align:center">
                                ...
                                <tr>
                                    <td
                                        style="border-collapse:collapse;border:0;padding: 10px;background-color: #f0d1d1 ; border-top:4px solid #c35876">


                                        <span>

                                            <a
                                                href="https://www.facebook.com/assignmentmasterqatar/"><img
                                                    src="{{ asset('imgs/email-footer/5a22b43e909176.0984090415122238065922.png') }}"
                                                    style="width:20px" alt="{{ config('app.name') }}"></a>


                                            <a href="https://www.instagram.com/assignmentmasterqatar/"><img
                                                    src="{{ asset('imgs/email-footer/5a355496a61e55.7452819615134445026804.png') }}"
                                                    style="width:20px" alt="{{ config('app.name') }}"></a>


                                            <a href="https://api.whatsapp.com/send?phone=97450345779 "><img
