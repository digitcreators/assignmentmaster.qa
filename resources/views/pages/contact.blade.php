@extends('layouts.web')
@section('title', 'Contact Assignment Master Qatar – We’re Here to Help')
@section('description', 'Get in touch with the friendly support team at Assignment Master Qatar. We’re ready to answer your questions and guide you through our services.')
...
<section class="py-5 mx-auto px-3">
    ...
    {{-- <p class="text-center text-4xl font-semibold py-4 px-4">Contact us</p> --}}
        ...
        <div class="container mx-auto grid grid-cols-1 md:grid-cols-2">
            <div class="text-center md:text-left lg:mt-15">
              ...
              <div class="flex flex-wrap items-center gap-6 py-2 justify-center md:justify-start">
                <div class="md:w-3/12 flex ">
                  <img src="{{ asset('imgs/contact-us.png')}}"
                ...
                <div class=" md:w-8/12 mt-3 md:mt-0 md:pl-3">
                  ...
                  <a href="tel:+974 5034 5779" class="block text-black">
                    +974 5034 5779
                  </a>
                </div>
              </div>
              ...
              <div class="flex flex-wrap items-center gap-6 py-2 mt-5 justify-center md:justify-start">
                <div class=" md:w-3/12 flex ">
                  <img src="{{ asset('imgs/send-mail.png')}}"
                       width="64" height="64" alt="Email" title="Email" />
                </div>
                <div class=" md:w-8/12 mt-3 md:mt-0 md:pl-3">
                  <span class="text-black text-lg font-bold block mb-0">SEND US EMAIL</span>
                  <a href="mailto:info@assignmentmaster.qa" class="block text-black">
                    info@assignmentmaster.qa
                  </a>
                </div>
              </div>
              ...
              <div class="text-center mt-5">
                ...
                <div class="mt-3 flex justify-center gap-4">
                  <!-- Facebook -->
                  <a href="https://www.facebook.com/assignmentmasterqatar/" target="_blank"
                  ...
                  <!-- Instagram -->
                  <a href="https://www.instagram.com/assignmentmasterqatar/" target="_blank"
            ...
            <h1 class="text-3xl font-semibold text-center span-header">
                        Contact Us
                        </h1>
                           ...
                           <select name="country"
                            ...
                            @foreach ($countries as $country)
                                <option class="bg-white" 
                                    value="{{ $country->name }}" 
                                    {{ old('country', 'Qatar') == $country->name ? 'selected' : '' }}>
                                    {{ $country->name }}
                                </option>    
                            @endforeach
                        </select>
