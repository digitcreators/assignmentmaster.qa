    ...
    <section>
        ...
        <div class="lg:mx-12 py-5">
            <div class="container mx-auto px-4 pb-4">
                ...
                <hr class="border border-primary-one bg-pri w-full h-[0.35rem] my-3 mx-auto" style="background: #c35876;">
            </div>
            <div class="mx-auto">
                <div class=" px-4 space-y-4 ">
                    <div class="border rounded-2xl max-w-sm mx-auto bg-white" style="box-shadow: 0 0 13px 5px rgb(174 0 0);">
                        <h4 class="py-2 text-xl text-center px-6 text-primary-two bg-primary-one rounded-t-2xl font-bold span-header">
                            Order Summary</h4>
                        <hr class="border-[2px]">
                        ...
                        <div class="w-full px-6 py-4">
                            <a href="{{ url('https://checkout.cvwriters.ae/payment?reference=' . $invoice->ref_no . '&gateway=stripe&source=am-qa') }}"
                        ...
                        <div class="span-header text-lg text-center mb-6">
                            <a href="{{ route('terms') }}">
                                Terms & Conditions
                            </a>
                        </div>
