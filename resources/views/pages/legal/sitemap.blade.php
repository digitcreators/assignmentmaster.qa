@extends('layouts.web')
@section('title', 'Assignment Master Qatar Sitemap - Navigate Our Services')
@section('description', 'Navigate Assignment Master Qatar with ease. Our sitemap helps you quickly find the services and pages you need for a smooth and efficient user experience.')
...
@section('content')
    ...
    <section class="aa my-10 px-10 py-5 text-white lg:px-32 px-5" style="background: rgb(246, 246, 246);">
        ...
        <div class="mx-2 my-4">
            <ul class="my-6 grid grid-cols-1 lg:grid-cols-4 text-center sm:text-left gap-3 sitemap-ul text-black">
               <li><a href="{{ route('book-writing') }}" >Book Writing</a></li>
                ...
                <li><a href="{{ route('essay-writing') }}" >Essay Writing</a></li>
                <li><a href="{{ route('dissertation-writing') }}" >Dissertation Writing</a></li>
                <li><a href="{{ route('college-assignment') }}" >College Assignment</a></li>
                <li><a href="{{ route('university-assignment') }}" >University Assignment</a></li>
                <li><a href="{{ route('personal-statement') }}" >Personal Statement</a></li>
                <li><a href="{{ route('cv-writing') }}" >CV Writing</a></li>
                <li><a href="{{ route('cipd-assignment') }}" >Cipd Assignment</a></li>
            </ul>
        </div>
