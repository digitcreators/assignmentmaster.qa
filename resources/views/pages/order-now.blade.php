@extends('layouts.web')
@section('title', 'Place Your Order Now - Assignment Master Qatar')
@section('description', 'Submit your order details and get expert academic support from Assignment Master Qatar. Original, plagiarism-free, and timely delivery.')
...
<section class="text-white py-10 order-sec">
    <h1 class="text-3xl pb-3 text-black text-center">Order Now</h1>
