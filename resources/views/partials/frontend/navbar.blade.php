...
<div class="bg-primary-one d-xl-block w-100 py-2" style="background: linear-gradient(to bottom, var(--color-secondary), var(--color-primary));">
    <div class=" lg:flex justify-between items-center mx-auto px-10 ">
        <a href="https://reviewsbank.org/review/assignmentmaster.qa" target="_blant" class="text-white flex items-center lg:justify-start justify-center">
        ...
        <div class="space-x-3 text-center sm:grid mt-1">
            <a href="https://api.whatsapp.com/send?phone=97450345779" class="text-white mr-4" target="_blank" aria-label="WhatsApp">
                <i class="fab fa-whatsapp text-white mr-2"></i>+974 5034 5779
            </a>
            <a href="tel:+97450345779" class="text-white mr-4" aria-label="Phone">
                <i class="fas fa-phone-alt text-white mr-2"></i>+974 5034 5779
            </a>
            <a href="mailto:info@assignmentmaster.qa" class="text-white mr-0" aria-label="Email">
                <i class="fas fa-envelope text-white mr-2"></i>info@assignmentmaster.qa
            </a>
        </div>
        <a href="https://www.facebook.com/assignmentmasterqatar/" class="btn btn-light btn-sm-square rounded-full" aria-label="Facebook">
            <i class="fab fa-facebook-f"></i>
        </a>
        <a href="https://www.instagram.com/assignmentmasterqatar/" class="btn btn-light btn-sm-square rounded-full" aria-label="Instagram">
...
<div class="w-full text-gray-700 dark-mode:text-gray-200 dark-mode:bg-gray-800  py-1" style="background-color: #FFFFFF; box-shadow: 2px 0px 13px -2px #da4f65;">
    <div x-data="{ open: false }"
        ...
        <div class="flex flex-row items-center justify-between md:justify-between">
            <a class="px-2" href="{{ route('home') }}">
                <img src="{{asset('imgs/logo.png')}}" alt="Logo" title="Logo" width="176" height="91" loading="eager">
            </a>
        ...
        <nav :class="{ 'flex': open, 'hidden': !open }"
           ...
           <div class="group inline-block relative" x-data="{ open: false }">
    <button @click="open = !open" class="nav-link font-semibold text-[#120d27] py-2 px-4 hover:text-primary-one inline-flex items-center">
    ...
    <ul 
        class="absolute bg-white left-0 lg:-left-[2rem] hidden group-hover:block text-sm text-black pt-1 z-20 w-[14rem] shadow border"
        :class="{'block': open, 'hidden': !open}"
    >
        <li class="border-b border-dotted border-blue-400">
            <a href="{{ route('book-writing') }}" class="border-b py-[0.5rem] px-4 block hover:text-primary-one">Book Writing</a>
        </li>
        <li class="border-b border-dotted border-blue-400">
            <a href="{{ route('ghost-writing') }}" class="border-b py-[0.5rem] px-4 block hover:text-primary-one">Ghost Writing</a>
        </li>
        <li class="border-b border-dotted border-blue-400">
            <a href="{{ route('thesis-writing') }}" class="border-b py-[0.5rem] px-4 block hover:text-primary-one">Thesis Writing</a>
        </li>
        <li class="border-b border-dotted border-blue-400">
            <a href="{{ route('academic-writing') }}" class="border-b py-[0.5rem] px-4 block hover:text-primary-one">Academic Writing</a>
        </li>
        <li class="border-b border-dotted border-blue-400">
            <a href="{{ route('proposal-writing') }}" class="border-b py-[0.5rem] px-4 block hover:text-primary-one">Proposal Writing</a>
        </li>
        <li class="border-b border-dotted border-blue-400">
            <a href="{{ route('dissertation-writing') }}" class="border-b py-[0.5rem] px-4 block hover:text-primary-one">Dissertation Writing</a>
        </li>
        <li class="border-b border-dotted border-blue-400">
            <a href="{{ route('essay-writing') }}" class="border-b py-[0.5rem] px-4 block hover:text-primary-one">Essay Writing</a>
        </li>
        <li class="border-b border-dotted border-blue-400">
            <a href="{{ route('college-assignment') }}" class="border-b py-[0.5rem] px-4 block hover:text-primary-one">College Assignment</a>
        </li>
        <li class="border-b border-dotted border-blue-400">
            <a href="{{ route('university-assignment') }}" class="border-b py-[0.5rem] px-4 block hover:text-primary-one">University Assignment</a>
        </li>
        <li class="border-b border-dotted border-blue-400">
            <a href="{{ route('personal-statement') }}" class="border-b py-[0.5rem] px-4 block hover:text-primary-one">Personal Statement</a>
        </li>
        <li class="border-b border-dotted border-blue-400">
            <a href="{{ route('cv-writing') }}" class="border-b py-[0.5rem] px-4 block hover:text-primary-one">CV Writing</a>
        </li>
        <li class="border-b border-dotted border-blue-400">
            <a href="{{ route('cipd-assignment') }}" class="border-b py-[0.5rem] px-4 block hover:text-primary-one">CIPD Assignment</a>
        </li>
    </ul>
</div>
