...
Route::group(['namespace'=> 'Web'], function(){
    ...
    // Services Routes
    Route::get('/book-writing', 'ServiceController@book_writing')->name('book-writing');
    Route::get('/cipd-assignment', 'ServiceController@cipd_assignment')->name('cipd-assignment');
    Route::get('/cv-writing', 'ServiceController@cv_writing')->name('cv-writing');
    Route::get('/ghost-writing', 'ServiceController@ghost_writing')->name('ghost-writing');
    Route::get('/thesis-writing', 'ServiceController@thesis_writing')->name('thesis-writing');
    Route::get('/academic-writing', 'ServiceController@academic_writing')->name('academic-writing');
    Route::get('/proposal-writing', 'ServiceController@proposal_writing')->name('proposal-writing');
    Route::get('/dissertation-writing', 'ServiceController@dissertation_writing')->name('dissertation-writing');
    Route::get('/essay-writing', 'ServiceController@essay_writing')->name('essay-writing');
    Route::get('/college-assignment', 'ServiceController@college_assignment')->name('college-assignment');
    Route::get('/university-assignment', 'ServiceController@university_assignment')->name('university-assignment');
    Route::get('/personal-statement', 'ServiceController@personal_statement')->name('personal-statement');
